        ...
        <div className="space-y-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-zinc-500 mt-2 font-medium">إضافة وإدارة فريق العمل الخاص بك.</p>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                    ...
                    <div className="col-span-full py-20 bg-zinc-900/50 border border-white/5 rounded-[3rem] text-center">
                        ...
                        <h3 className="text-xl font-bold text-white">لا يوجد موظفون بعد</h3>
                        <p className="text-zinc-500 mt-2">ابدأ بإضافة أول موظف لفريقك الآن.</p>
                    </div>
                ) : (
                    staff.map((s, i) => (
                        <motion.div
                        ...
                        >
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-xl font-bold text-white group-hover:text-indigo-400 transition-colors">{s.name || "بدون اسم"}</h3>
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-white/5">
                                <div className="text-right">
                                    <p className="text-zinc-600 text-[10px] font-black uppercase tracking-widest mb-1">تاريخ الانضمام</p>
                                    <p className="text-zinc-400 text-xs font-bold">{new Date(s.createdAt).toLocaleDateString("ar-EG")}</p>
                                </div>
                ...
                {showAddModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
                        ...
                        >
                            ...
                            <h2 className="text-3xl font-black text-white mb-2 relative">إضافة موظف جديد</h2>
                            <p className="text-zinc-500 text-sm mb-10 font-medium relative">سيتم تعيين هذا المستخدم كـ (Staff) في عملك تلقائياً.</p>
